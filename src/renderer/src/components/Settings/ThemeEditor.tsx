...
const CSS_DEFAULTS_DARK: Record<string, string> = {
  ...
  '--bg-header': '#1d1d1d',
  '--bg-button': '#232323',
  '--bg-button-hover': '#313131',
  '--bg-active': '#313131',
  '--card-bg': '#161616',
  '--column-bg': '#121212',
  '--resize-handle': '#313131',
  '--resize-handle-hover': 'rgba(58, 150, 221, 0.4)',
  '--text-primary': '#cccccc',
  '--text-secondary': '#9d9d9d',
  '--text-muted': '#767676',
  '--text-faint': '#4e4e4e',
  '--border-primary': '#313131',
  '--border-subtle': '#232323',
  '--border-input': '#313131',
  '--card-border': '#2e2e2e',
  '--card-hover-border': '#454545',
  '--column-border': 'rgba(49, 49, 49, 0.6)',
  '--accent': '#3a96dd',
  '--accent-hover': '#4da6e8',
  ...
  '--bg-diff-del': '#38151a',
  '--bg-diff-hunk': '#1d1d1d',
  '--bg-diff-context': '#0c0c0c',
  '--text-diff-add': '#16c60c',
  '--text-diff-del': '#e74856',
  '--text-diff-hunk': '#8a8a8a',
  '--text-diff-context': '#767676',
  '--border-diff-add': '#16c60c',
  '--border-diff-del': '#e74856',
}
...
const TERMINAL_LABELS: Record<string, string> = {
  ...
  black: 'dim text, borders',
  red: 'errors, deletions',
  green: 'success, additions',
  yellow: 'warnings, modified',
  blue: 'directories, links',
  magenta: 'keywords, special',
  cyan: 'constants, paths',
  white: 'secondary text',
  brightBlack: 'comments',
  brightRed: 'bold errors',
  brightGreen: 'bold success',
  brightYellow: 'bold warnings',
  brightBlue: 'bold links',
  brightMagenta: 'bold keywords',
  brightCyan: 'bold constants',
  brightWhite: 'bold text',
}
